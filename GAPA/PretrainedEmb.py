...
def get_pretrained_emb(model, tokenizer, sentences, entity_pos, eid2idx, np_file, dim=1024, batch_size=1024):  # 768
...
if __name__ == '__main__':
    ...
    parser.add_argument('-dataset', default='./', help='path to dataset folder')
    parser.add_argument(
